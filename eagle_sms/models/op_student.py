...
class opstudentSMS(models.Model):
    ...
    def sms_action(self):
        ...
        return {
            ...
            'context': {'default_from_mobile_id': default_mobile.id,'default_to_number':self.mobile, 'default_record_id':self.id,'default_model':'op.student'}
         }
