    ...
    def get_student_vals(self):
        for student in self:
            return {
                ...
                'classes_id':
                    student.classes_id and student.classes_id.id or False,
    ...
    def enroll_student(self):
        for record in self:
            ...
            if not record.student_id:
                ...
                record.student_id.write({
                    'course_detail_ids': [[0, False, {
                        ...
                        'classes_id':
                            record.classes_id and record.classes_id.id or False,
                        'roll_number':
                            record.roll_no and record.roll_no or False,
                        'section_id':
                            record.section_id and record.section_id.id or False,
                    }]],
                })
            ...
            reg_id = self.env['op.subject.registration'].create({
                ...
                'classes_id': record.classes_id.id,
